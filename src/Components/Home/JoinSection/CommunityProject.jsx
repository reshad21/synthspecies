...
const CommunityProject = () => {
    return (
        <div>
            <h2 className='text-3xl font-bold py-4'>Community Projects</h2>
            <p className='text-xl'>In addition to the official links above, you may also check out these fan-operated communities and resources:</p>
            <ul className='py-8 flex flex-col gap-3 pl-48'>
